...
const Navbar = () => {
  ...
  return (
    <div className="h-16 bg-[var(--secondary-color)] border-b border-gray-400 fixed top-0 left-0 right-0 duration-300 z-10">
      {/* Desktop */}
      <div className="max-w-7xl mx-auto hidden md:flex justify-between items-center gap-10 h-full">
        <div className="flex items-center gap-2">
          <School2 size={"30"} className="text-white"/>
          <Link to="/">
            <h1 className="hidden md:block font-extrabold text-2xl text-white">
              ACADE<i className="text-[var(--primary-color)]">MIA</i>
            </h1>
          </Link>
        </div>
